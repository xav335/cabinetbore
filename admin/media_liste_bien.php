...
<body id="fond_blanc" leftmargin="0" topmargin="0" bgproperties="fixed" id="fond_rose" onLoad="MM_preloadImages('images/modifier_over.gif','images/supprimer_over.gif','images/chercher_over.gif')" border="0">
	...
	<tr> 
		...
		?>
		<h2>Images du bien réf. <?  echo $row["reference"]." : ".$row["titre"]; ?></h2>
		</td>
	</tr>
  	</table>
</form>
	...
	<? if (mysql_num_rows($result)>0) {?>
    	<td valign="top">
			...
			<tr align="center""> 
				...
				<td class="<? echo $class_ch?>" align="left"><a href="media_suppr.php?id_bien=<? echo $_POST["id_bien"] ?>&id_media_bien=<? echo $row["id_media_bien"]?>" onClick="return confirm('êtes-vous sûr de vouloir supprimer le media <? echo $row["id_media_bien"] ?> ?')"><img src="supprimer_off.gif" alt="" width="13" height="13" border="0"></a></td>
	        </tr>
				<? $cc++ ?>	
			<? }?>
	      	</table>
