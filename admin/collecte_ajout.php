...
<tr>
	<td align="center" valign="middle">
        ...
        <form action="collecte_ajout_2.php" method="post" name="formulaire"  onsubmit="return Form1_Validator(this)" enctype="application/x-www-form-urlencoded">
        	<input type="hidden" name="id_collecte" value="<? echo $id_collecte?>">
        	<tr>
            		<td align="center" id="texte3">Ajout Collecte</td>
        	</tr>
        	<tr> 
			...
			<tr> 
                  <td> <table cellspacing="0" cellpadding="0" border="0">
                      <tr> 
                        <td id="texte2b">tranche_horaire:<br> <br> 
                          	<?
