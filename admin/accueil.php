                    ...
                    <tr> 
                      ...
                      <td width="100%" height="560" align="left" valign="top"> 
                        <table width="167" border="0" cellpadding="0" cellspacing="0">
                          ...
                          <tr> 
                            <td height="25" align="left" valign="top" id="texte3_rouge">ADMIN BORÉ</td>
                          </tr>
                          <tr> 
                            <td width="167" height="183" align="left" valign="top">&nbsp;</td>
                          </tr>
                          <tr> 
                            <td height="25" align="left" valign="top" id="texte2_rouge">Gestion Biens</td>
                          </tr>
                          <tr> 
                          ...
                          <tr> 
                            <td width="167" height="10" align="left" valign="top">&nbsp;</td>
                          </tr>
						  <tr>
...
oCMenu.makeMenu('top0','','<span ID="crochet_menu">[</span>&nbsp;Biens','','produit','150','19','','','','','bottom')	
	oCMenu.makeMenu('sub00','top0','&nbsp;ajouter un bien','<?=$chemin?>admin/bien_ajout.php','produit','146')
	oCMenu.makeMenu('sub01','top0','&nbsp;modifier/supprimer','<?=$chemin?>admin/bien_liste.php','produit','146')
